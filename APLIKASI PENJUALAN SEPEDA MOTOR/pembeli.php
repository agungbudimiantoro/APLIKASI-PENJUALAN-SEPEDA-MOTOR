    ...
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-sm-8">
                ...
                <h3>Pembeli</h3>
                <br>
                <a href="pembeli_tambah.php" class="btn btn-info">Tambah Data pembeli</a>
                <br>
                <hr>
                <table class="table">
                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><? echo $data["nama_pembeli"]; ?></td>
                                <td><? echo $data["tgl_lahir"]; ?></td>
                                <td><? echo $data["jenis_kelamin"]; ?></td>
                                <td><? echo $data["alamat"]; ?></td>
                                <td><a href="pembeli_ubah.php?id=<? echo $data["id_pembeli"]; ?>" class="badge badge-light">ubah</a>
                                    <a href="pembeli_hapus.php?id=<? echo $data["id_pembeli"]; ?>" class="badge badge-dark">Hapus</a></td>
